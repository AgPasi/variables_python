...
padre_1 = str(input("Nombre Completo del padre: "))
padre_2 = str(input("Nombre completo de la Madre: "))

hijo = str(input("Nombre del Hijo: "))
...
#print("Nombre Completo del Hijo: " + hijo + " " + z[1] + " " + z[-1])