...
while True:
    try:
        ...
        print("Solo se admiten numeros, vuelve a intentarlo.")
...
print("Nombre Completo: " + nombre_completo + ", " + "DNI:" + str(dni))
print("Nombre Completo: " + nombre_completo + ", " + "EDAD:" + str(edad) + ", " + str(altura) + "cm")
